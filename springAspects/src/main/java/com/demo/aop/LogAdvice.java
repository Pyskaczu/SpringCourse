...
//	@Before("execution(String com.demo.vehicles.CarAdvice.drive(..))")
...
//	}
//	
//	@AfterReturning(pointcut="execution(String com.demo.vehicles.CarAdvice.drive(..))", returning="ret")
//	public void vehicleMoved(String ret) {
//		System.out.print("Car is moving now: ");
//		System.out.println(ret);
//	}
//	
//	@AfterThrowing(pointcut="execution(String com.demo.vehicles.CarAdvice.drive(..))", throwing="ex")
//	public void vehicleThrewExcDuringMoving(Exception ex) {
//		System.out.println(ex.getMessage());
//	}
//	
//	@After("execution(String com.demo.vehicles.CarAdvice.drive(..))")
//	public void vehicleCouldMove() {
//		System.out.println("Executed regardless exceptions");
//	}

	// works when other advises are disabled
	@Around("execution(String com.demo.vehicles.CarAdvice.drive(..))")
